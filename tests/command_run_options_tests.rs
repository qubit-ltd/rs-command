...
fn test_command_run_options_store_cancellation_and_tee_paths() {
    ...
    assert_eq!(options.configured_stdout_file(), Some(Path::new("stdout.log")));
    assert_eq!(options.configured_stderr_file(), Some(Path::new("stderr.log")));
}
...
fn test_command_run_options_clone_copies_tee_paths() {
    ...
    assert_eq!(clone.configured_stdout_file(), options.configured_stdout_file());
    assert_eq!(clone.configured_stderr_file(), options.configured_stderr_file());
}
